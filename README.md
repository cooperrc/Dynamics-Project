...
To do this you use the function _linspace(0,5,500)_ -- This creates a vector between 0 and 5 with 500 equally spaced entries (or .01 sec between each entry).  
